...
public interface RoutingAlgorithm {
	 ...
	 * which are candidates for the responsible (root) node for the specified ID.
	...
	/**
	 * Adjusts the responsible (root) node.
	 * This method is invoked on the nearest node calculated by
	 * {@link #closestTo(ID, int, RoutingContext) closestNodes()}.
	 *
	 * In case of Chord, the goal of a routing is the successor of the specified ID,
	 ...
	 * the responsible (root) node for the ID of this node.
	 *
